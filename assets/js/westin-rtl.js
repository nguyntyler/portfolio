...
$(document).ready(function () {
	...
	$(".sidebar .navbar-nav a, .sidebar .list-group a").on(
		"click",
		function (event) {
			var $anchor = $(this);
			$root.stop().animate(
	...
	if ($window.width() < 1199) {
		...
		$(".sidebar .navbar-nav a, .sidebar .list-group a").on(
			...
			function () {
				setTimeout(function () {
					$sidebarToggler.toggleClass(
						"move lni-chevron-left lni-menu"
					);
					$sidebar.toggleClass("hide");
					$pageContent.toggleClass("full-width");
				});
	...
	$("ul.pattern .color1").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/azure.css"), !1
		);
	});
	...
	$("ul.pattern .color3").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/purple.css"), !1
		);
	});
	$("ul.pattern .color4").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/dark-purple.css"),
			!1
		);
	});
	$("ul.pattern .color5").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/golden.css"), !1
		);
	});
	$("ul.pattern .color6").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/green.css"), !1
		);
	});
	$("ul.pattern .color7").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/citrus.css"), !1
		);
	});
	$("ul.pattern .color8").on("click", function () {
		return (
			$("#option-color").attr(
				"href",
				"assets/css/color/light-orange.css"
			),
			!1
		);
	});
	$("ul.pattern .color9").on("click", function () {
		return (
			$("#option-color").attr("href", "assets/css/color/orange.css"), !1
		);
	});
	...
	$("ul.pattern .color13").on("click", function () {
		return (
			$("#option-color-two").attr("href", "assets/css/color/pink.css"), !1
		);
	});
	$("ul.pattern .color14").on("click", function () {
		return (
			$("#option-color-two").attr(
				"href",
				"assets/css/color/sky-blue.css"
			),
			!1
		);
	});
	$("ul.pattern .color15").on("click", function () {
		return (
			$("#option-color-two").attr("href", "assets/css/color/golden.css"),
			!1
		);
	});
	...
	function updateFilterCounts() {
		...
		if (count_items > initial_items) {
			...
			$showMore
				...
				.addClass("ml-2 ml-sm-4")
				.removeClass("p-0");
		} else {
			$showMore.hide();
			$showMore
				.parent(".button-border")
				.removeClass("ml-2 ml-sm-4")
				.addClass("p-0");
		}
